...
# Install the Agent
ADD https://circle-artifacts.com/gh/DataDog/docker-dd-agent-build-deb-x64/666/artifacts/0/home/ubuntu/docker-dd-agent-build-deb-x64/pkg/datadog-agent_5.7.0.git.145.099518a-1_amd64.deb /
RUN dpkg -i /datadog-agent_5.7.0.git.145.099518a-1_amd64.deb && rm /datadog-agent_5.7.0.git.145.099518a-1_amd64.deb
